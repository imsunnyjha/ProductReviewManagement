    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<ProductReview> listProductReview = new List<ProductReview>()
            {
                ...
                new ProductReview(){ProductID=18,UserID=25,Rating=2,Review="Okay",isLike=true},
                new ProductReview(){ProductID=15,UserID=27,Rating=1,Review="Poor",isLike=true},
                new ProductReview(){ProductID=10,UserID=10,Rating=5,Review="Super",isLike=true},
                new ProductReview(){ProductID=17,UserID=31,Rating=4,Review="Great",isLike=true},
                new ProductReview(){ProductID=11,UserID=33,Rating=3,Review="Good",isLike=true},
