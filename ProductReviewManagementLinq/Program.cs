    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<ProductReview> listProductReview = new List<ProductReview>()
            {
                ...
                new ProductReview(){ProductID=7,UserID=15,Rating=3,Review="Good",isLike=true},
                new ProductReview(){ProductID=8,UserID=17,Rating=2,Review="Okay",isLike=true},
                new ProductReview(){ProductID=20,UserID=18,Rating=1,Review="Poor",isLike=true},
                ...
                new ProductReview(){ProductID=14,UserID=23,Rating=3,Review="Good",isLike=true},
                ...
                new ProductReview(){ProductID=14,UserID=29,Rating=5,Review="Super",isLike=true},
                ...
                new ProductReview(){ProductID=11,UserID=39,Rating=5,Review="Super",isLike=true},
